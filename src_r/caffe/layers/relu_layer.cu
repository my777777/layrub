...
//      CHECK(char_bottom_data_)<<"char_bottom_data_ is NULL!";
      if(!char_bottom_data){
    	  char_bottom_data.reset(new SyncedMemory(count*sizeof(char)));
    	  LOG(INFO)<<" char_bottom_data alloc.";
      }
  	  TransformData<Dtype><<<CAFFE_GET_BLOCKS(count),CAFFE_CUDA_NUM_THREADS>>>(
  			  count, bottom_data, (char*)(char_bottom_data->mutable_gpu_data()));//170728
  	  CUDA_POST_KERNEL_CHECK;
    }
    ///////////////////////////////////////////////////////////////////////
  ...
  if (propagate_down[0]) {
    ...
    ///////////////////////////////////////////////////////////////////// 4
	  ...
	  ReLUBackward_char_data<Dtype><<<CAFFE_GET_BLOCKS(count), CAFFE_CUDA_NUM_THREADS>>>(
		count, top_diff, (char*)(char_bottom_data->gpu_data()), bottom_diff);//170728
	  CUDA_POST_KERNEL_CHECK;
	}
    /////////////////////////////////////////////////////////////////////
