...
void ScaleLayer<Dtype>::TransferDataToCPU(cudaStream_t& stream, int count){
	...
	//sum_result_.TransferToCPU(stream); sum_result_ only need in Backward, so don't need to offload
	//////////////////////////////////////////////////////////
}
...
void ScaleLayer<Dtype>::TransferDataToGPU(cudaStream_t& stream, int count){
	...
	//sum_result_.TransferToGPU(stream); sum_result_ only need in Backward, so don't need to load
	//////////////////////////////////////////////////////////
}
...
/*template <typename Dtype>
Blob<Dtype>& ScaleLayer<Dtype>::sum_multiplier_Blob(){
	return sum_multiplier_;
}

template <typename Dtype>
Blob<Dtype>& ScaleLayer<Dtype>::sum_result_Blob(){
	return sum_result_;
}*/
////////////////////////////////////////////////////////////////////////////
