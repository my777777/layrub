...
class ReLULayer : public NeuronLayer<Dtype> {
 public:
  ...
  explicit ReLULayer(const LayerParameter& param)
      : NeuronLayer<Dtype>(param), char_bottom_data(), char_data_cpu_ptr_(NULL) {}//////////////////////////////////////170728
...
//      LOG(INFO)<<"~relu_layer()..."<<this->layer_param_.name();
      CUDA_CHECK(cudaFree(char_bottom_data_));
     }*/
    if(char_data_cpu_ptr_){//170728
...
//  char* cpu_char_bottom_data_ ;
//  void Alloc_data(size_t size);//170728
  shared_ptr<SyncedMemory> char_bottom_data;
//  const shared_ptr<SyncedMemory>& CharData() const;
